...
export const TOWER_FLOORS = [
  {
    ...
    weapon: WeaponType.STAFF, aiLevel: 2,
    intro: '路经偏僻村落，一名壮汉持棍拦路。',
    taunt: '此路是我开！留下买路钱！',
  },
  {
    floor: 2, npc: '赵三', title: '山贼喽啰',
    weapon: WeaponType.SHORT_BLADE, aiLevel: 3,
    intro: '山间小道，草丛中窜出一名手持短刀的毛贼。',
    taunt: '识相的把包袱留下！',
  },
  {
    floor: 3, npc: '钱小六', title: '镖局镖师',
    weapon: WeaponType.SPEAR, aiLevel: 4,
